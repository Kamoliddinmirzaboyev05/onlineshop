...
const dict = {
  uz: {
    ...
    location_off: "Joylashuv xizmati o'chiq — yaqin do'konni topish uchun uni yoqing",
  ...
  ru: {
    ...
    location_off: "Геолокация устройства выключена — включите её, чтобы найти ближайший магазин",
